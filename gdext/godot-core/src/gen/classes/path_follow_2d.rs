...
pub(super) mod re_export {
    ...
    pub trait IPathFollow2D: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl PathFollow2D {
        ...
        pub fn set_rotates(&mut self, enabled: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_rotates", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_rotating(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "is_rotating", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for PathFollow2D {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"PathFollow2D\0")
        }
    ...
    impl crate::obj::ExportableObject for PathFollow2D {
