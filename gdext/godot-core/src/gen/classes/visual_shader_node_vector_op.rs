...
pub(super) mod re_export {
    ...
    pub trait IVisualShaderNodeVectorOp: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl VisualShaderNodeVectorOp {
        ...
        pub fn set_operator(&mut self, op: crate::engine::visual_shader_node_vector_op::Operator,) {
            type RetMarshal = PtrcallReturnUnit;
            type CallSig = ((), crate::engine::visual_shader_node_vector_op::Operator);
            let args = (op,);
            unsafe {
        ...
        pub fn get_operator(&self,) -> crate::engine::visual_shader_node_vector_op::Operator {
            type RetMarshal = PtrcallReturnT < crate::engine::visual_shader_node_vector_op::Operator >;
            type CallSig = (crate::engine::visual_shader_node_vector_op::Operator,);
            let args = ();
            unsafe {
    ...
    impl crate::obj::GodotClass for VisualShaderNodeVectorOp {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"VisualShaderNodeVectorOp\0")
        }
    ...
    impl crate::obj::ExportableObject for VisualShaderNodeVectorOp {
...
impl Operator {
    ...
    pub const OP_CROSS: Self = Self {
        ord: 8i32
    };
    pub const OP_ATAN2: Self = Self {
        ord: 9i32
    };
    pub const OP_REFLECT: Self = Self {
        ord: 10i32
    };
