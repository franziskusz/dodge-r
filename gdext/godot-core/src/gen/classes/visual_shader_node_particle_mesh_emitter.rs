...
pub(super) mod re_export {
    ...
    pub trait IVisualShaderNodeParticleMeshEmitter: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl VisualShaderNodeParticleMeshEmitter {
        ...
        pub fn set_use_all_surfaces(&mut self, enabled: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_use_all_surfaces", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_use_all_surfaces(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "is_use_all_surfaces", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_surface_index(&mut self, surface_index: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_surface_index", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_surface_index(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_surface_index", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for VisualShaderNodeParticleMeshEmitter {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"VisualShaderNodeParticleMeshEmitter\0")
        }
    ...
    impl crate::obj::Inherits < crate::engine::VisualShaderNodeParticleEmitter > for VisualShaderNodeParticleMeshEmitter {
    ...
    impl crate::obj::ExportableObject for VisualShaderNodeParticleMeshEmitter {
    ...
    macro_rules !inherits_transitive_VisualShaderNodeParticleMeshEmitter {
        ($Class: ident) => {
            impl::godot::obj::Inherits < ::godot::engine::VisualShaderNodeParticleMeshEmitter > for $Class {
