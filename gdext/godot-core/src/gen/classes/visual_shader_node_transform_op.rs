...
pub(super) mod re_export {
    ...
    pub trait IVisualShaderNodeTransformOp: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl VisualShaderNodeTransformOp {
        ...
        pub fn set_operator(&mut self, op: crate::engine::visual_shader_node_transform_op::Operator,) {
            type RetMarshal = PtrcallReturnUnit;
            type CallSig = ((), crate::engine::visual_shader_node_transform_op::Operator);
            let args = (op,);
            unsafe {
        ...
        pub fn get_operator(&self,) -> crate::engine::visual_shader_node_transform_op::Operator {
            type RetMarshal = PtrcallReturnT < crate::engine::visual_shader_node_transform_op::Operator >;
            type CallSig = (crate::engine::visual_shader_node_transform_op::Operator,);
            let args = ();
            unsafe {
    ...
    impl crate::obj::GodotClass for VisualShaderNodeTransformOp {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"VisualShaderNodeTransformOp\0")
        }
    ...
    impl crate::obj::ExportableObject for VisualShaderNodeTransformOp {
...
impl Operator {
    ...
    pub const OP_AxB_COMP: Self = Self {
        ord: 2i32
    };
    pub const OP_BxA_COMP: Self = Self {
        ord: 3i32
    };
    pub const OP_ADD: Self = Self {
        ord: 4i32
    };
    pub const OP_A_MINUS_B: Self = Self {
        ord: 5i32
    };
    pub const OP_B_MINUS_A: Self = Self {
        ord: 6i32
    };
    pub const OP_A_DIV_B: Self = Self {
        ord: 7i32
    };
    pub const OP_B_DIV_A: Self = Self {
        ord: 8i32
    };
