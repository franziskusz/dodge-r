...
pub(super) mod re_export {
    ...
    pub trait IVisualShaderNodeTexture2DArray: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl VisualShaderNodeTexture2DArray {
        ...
        pub fn set_texture_array(&mut self, value: Gd < crate::engine::Texture2DArray >,) {
            type RetMarshal = PtrcallReturnUnit;
            type CallSig = ((), Gd < crate::engine::Texture2DArray >);
            let args = (value,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(9608usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_texture_array", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_texture_array(&self,) -> Option < Gd < crate::engine::Texture2DArray > > {
            type RetMarshal = PtrcallReturnOptionGdT < Gd < crate::engine::Texture2DArray > >;
            type CallSig = (Option < Gd < crate::engine::Texture2DArray > >,);
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(9609usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_texture_array", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for VisualShaderNodeTexture2DArray {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"VisualShaderNodeTexture2DArray\0")
        }
    ...
    impl crate::obj::Inherits < crate::engine::VisualShaderNodeSample3D > for VisualShaderNodeTexture2DArray {
    ...
    impl crate::obj::ExportableObject for VisualShaderNodeTexture2DArray {
    ...
    macro_rules !inherits_transitive_VisualShaderNodeTexture2DArray {
        ($Class: ident) => {
            impl::godot::obj::Inherits < ::godot::engine::VisualShaderNodeTexture2DArray > for $Class {
