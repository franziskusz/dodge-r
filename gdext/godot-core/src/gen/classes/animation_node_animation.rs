...
pub(super) mod re_export {
    ...
    pub trait IAnimationNodeAnimation: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl AnimationNodeAnimation {
        ...
        pub fn set_play_mode(&mut self, mode: crate::engine::animation_node_animation::PlayMode,) {
            type RetMarshal = PtrcallReturnUnit;
            type CallSig = ((), crate::engine::animation_node_animation::PlayMode);
            let args = (mode,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(291usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_play_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_play_mode(&self,) -> crate::engine::animation_node_animation::PlayMode {
            type RetMarshal = PtrcallReturnT < crate::engine::animation_node_animation::PlayMode >;
            type CallSig = (crate::engine::animation_node_animation::PlayMode,);
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(292usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_play_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for AnimationNodeAnimation {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"AnimationNodeAnimation\0")
        }
    ...
    impl crate::obj::ExportableObject for AnimationNodeAnimation {
...
impl PlayMode {
    pub const PLAY_MODE_FORWARD: Self = Self {
        ord: 0i32
    };
    pub const PLAY_MODE_BACKWARD: Self = Self {
        ord: 1i32
    };
...
impl crate::builtin::meta::GodotConvert for PlayMode {
    type Via = i32;
    
}
impl crate::builtin::meta::ToGodot for PlayMode {
    fn to_godot(&self) -> Self::Via {
        < Self as crate::obj::EngineEnum > ::ord(* self)
    }
}
impl crate::builtin::meta::FromGodot for PlayMode {
