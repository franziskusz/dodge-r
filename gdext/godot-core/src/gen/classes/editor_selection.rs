...
pub(super) mod re_export {
    ...
    pub trait IEditorSelection: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl EditorSelection {
        ...
        pub fn add_node(&mut self, node: Gd < crate::engine::Node >,) {
            type RetMarshal = PtrcallReturnUnit;
        ...
        pub fn remove_node(&mut self, node: Gd < crate::engine::Node >,) {
            type RetMarshal = PtrcallReturnUnit;
            type CallSig = ((), Gd < crate::engine::Node >);
            let args = (node,);
            unsafe {
        ...
        pub fn get_selected_nodes(&mut self,) -> Array < Gd < crate::engine::Node > > {
            type RetMarshal = PtrcallReturnT < Array < Gd < crate::engine::Node > > >;
            type CallSig = (Array < Gd < crate::engine::Node > >,);
            let args = ();
            unsafe {
                let method_bind = sys::class_editor_api() . fptr_by_index(255usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_selected_nodes", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_transformable_selected_nodes(&mut self,) -> Array < Gd < crate::engine::Node > > {
            type RetMarshal = PtrcallReturnT < Array < Gd < crate::engine::Node > > >;
            type CallSig = (Array < Gd < crate::engine::Node > >,);
            let args = ();
            unsafe {
                let method_bind = sys::class_editor_api() . fptr_by_index(256usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_transformable_selected_nodes", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for EditorSelection {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"EditorSelection\0")
        }
