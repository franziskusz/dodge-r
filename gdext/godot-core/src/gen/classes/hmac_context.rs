...
pub(super) mod re_export {
    ...
    pub trait IHmacContext: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl HmacContext {
        ...
        pub fn start(&mut self, hash_type: crate::engine::hashing_context::HashType, key: PackedByteArray,) -> crate::engine::global::Error {
            type RetMarshal = PtrcallReturnT < crate::engine::global::Error >;
            type CallSig = (crate::engine::global::Error, crate::engine::hashing_context::HashType, PackedByteArray);
            let args = (hash_type, key,);
            unsafe {
        ...
        pub fn update(&mut self, data: PackedByteArray,) -> crate::engine::global::Error {
            type RetMarshal = PtrcallReturnT < crate::engine::global::Error >;
    ...
    impl crate::obj::GodotClass for HmacContext {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"HMACContext\0")
        }
