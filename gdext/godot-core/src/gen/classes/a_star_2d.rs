...
pub(super) mod re_export {
    ...
    pub trait IAStar2D: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl AStar2D {
        ...
        #[inline]
        pub fn add_point_ex(&mut self, id: i64, position: Vector2,) -> ExAddPoint < '_ > {
        ...
        #[inline]
        pub fn get_closest_point_ex(&self, to_position: Vector2,) -> ExGetClosestPoint < '_ > {
    ...
    impl crate::obj::GodotClass for AStar2D {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"AStar2D\0")
        }
...
pub struct ExAddPoint < 'a > {
    surround_object: &'a mut re_export::AStar2D, id: i64, position: Vector2, weight_scale: f32,
}
...
impl < 'a > ExAddPoint < 'a > {
    ...
    #[inline]
    pub fn done(self) {
        re_export::AStar2D::add_point_full(self.surround_object, self.id, self.position, self.weight_scale,)
    }
}
...
pub struct ExSetPointDisabled < 'a > {
    surround_object: &'a mut re_export::AStar2D, id: i64, disabled: bool,
}
#[allow(clippy::wrong_self_convention, clippy::redundant_field_names, clippy::needless_update)]
impl < 'a > ExSetPointDisabled < 'a > {
    ...
    #[inline]
    pub fn done(self) {
        re_export::AStar2D::set_point_disabled_full(self.surround_object, self.id, self.disabled,)
    }
}
#[doc = "Default-param extender for [`AStar2D::connect_points_ex`][super::AStar2D::connect_points_ex]."]
#[must_use]
pub struct ExConnectPoints < 'a > {
    surround_object: &'a mut re_export::AStar2D, id: i64, to_id: i64, bidirectional: bool,
}
#[allow(clippy::wrong_self_convention, clippy::redundant_field_names, clippy::needless_update)]
impl < 'a > ExConnectPoints < 'a > {
    ...
    #[inline]
    pub fn done(self) {
        re_export::AStar2D::connect_points_full(self.surround_object, self.id, self.to_id, self.bidirectional,)
    }
}
...
impl < 'a > ExDisconnectPoints < 'a > {
    ...
    #[inline]
    pub fn done(self) {
        re_export::AStar2D::disconnect_points_full(self.surround_object, self.id, self.to_id, self.bidirectional,)
    }
}
...
pub struct ExArePointsConnected < 'a > {
    surround_object: &'a re_export::AStar2D, id: i64, to_id: i64, bidirectional: bool,
}
#[allow(clippy::wrong_self_convention, clippy::redundant_field_names, clippy::needless_update)]
impl < 'a > ExArePointsConnected < 'a > {
    ...
    pub fn done(self) -> bool {
        re_export::AStar2D::are_points_connected_full(self.surround_object, self.id, self.to_id, self.bidirectional,)
    }
}
...
pub struct ExGetClosestPoint < 'a > {
    surround_object: &'a re_export::AStar2D, to_position: Vector2, include_disabled: bool,
}
#[allow(clippy::wrong_self_convention, clippy::redundant_field_names, clippy::needless_update)]
impl < 'a > ExGetClosestPoint < 'a > {
    ...
    pub fn done(self) -> i64 {
        re_export::AStar2D::get_closest_point_full(self.surround_object, self.to_position, self.include_disabled,)
    }
}