...
pub(super) mod re_export {
    ...
    pub trait ICollisionShape2D: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl CollisionShape2D {
        ...
        pub fn set_debug_color(&mut self, color: Color,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_debug_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_debug_color(&self,) -> Color {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_debug_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for CollisionShape2D {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"CollisionShape2D\0")
        }
    ...
    impl crate::obj::ExportableObject for CollisionShape2D {
