...
pub(super) mod re_export {
    ...
    pub trait ISpringArm3D: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl SpringArm3D {
        pub fn get_hit_length(&mut self,) -> f32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_hit_length", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn add_excluded_object(&mut self, RID: Rid,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "add_excluded_object", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn remove_excluded_object(&mut self, RID: Rid,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "remove_excluded_object", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn clear_excluded_objects(&mut self,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "clear_excluded_objects", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for SpringArm3D {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"SpringArm3D\0")
        }
    ...
    impl crate::obj::ExportableObject for SpringArm3D {
