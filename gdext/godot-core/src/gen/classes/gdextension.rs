...
pub(super) mod re_export {
    ...
    pub trait IGDExtension: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl GDExtension {
        ...
        pub fn open_library(&mut self, path: GString, entry_symbol: GString,) -> crate::engine::global::Error {
            type RetMarshal = PtrcallReturnT < crate::engine::global::Error >;
            type CallSig = (crate::engine::global::Error, GString, GString);
            let args = (path, entry_symbol,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(3084usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "open_library", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn close_library(&mut self,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "close_library", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_library_open(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "is_library_open", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_minimum_library_initialization_level(&self,) -> crate::engine::gdextension::InitializationLevel {
            type RetMarshal = PtrcallReturnT < crate::engine::gdextension::InitializationLevel >;
            type CallSig = (crate::engine::gdextension::InitializationLevel,);
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(3087usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_minimum_library_initialization_level", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn initialize_library(&mut self, level: crate::engine::gdextension::InitializationLevel,) {
            type RetMarshal = PtrcallReturnUnit;
            type CallSig = ((), crate::engine::gdextension::InitializationLevel);
            let args = (level,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(3088usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "initialize_library", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for GDExtension {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"GDExtension\0")
        }
    ...
    impl crate::obj::ExportableObject for GDExtension {
...
impl InitializationLevel {
    pub const INITIALIZATION_LEVEL_CORE: Self = Self {
        ord: 0i32
    };
    pub const INITIALIZATION_LEVEL_SERVERS: Self = Self {
        ord: 1i32
    };
    pub const INITIALIZATION_LEVEL_SCENE: Self = Self {
        ord: 2i32
    };
    pub const INITIALIZATION_LEVEL_EDITOR: Self = Self {
        ord: 3i32
    };
...
impl crate::builtin::meta::GodotConvert for InitializationLevel {
    type Via = i32;
    
}
impl crate::builtin::meta::ToGodot for InitializationLevel {
    fn to_godot(&self) -> Self::Via {
        < Self as crate::obj::EngineEnum > ::ord(* self)
    }
}
impl crate::builtin::meta::FromGodot for InitializationLevel {
