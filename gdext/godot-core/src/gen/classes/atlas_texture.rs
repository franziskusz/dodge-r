...
pub(super) mod re_export {
    ...
    pub trait IAtlasTexture: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl AtlasTexture {
        ...
        pub fn set_atlas(&mut self, atlas: Gd < crate::engine::Texture2D >,) {
            type RetMarshal = PtrcallReturnUnit;
            type CallSig = ((), Gd < crate::engine::Texture2D >);
            let args = (atlas,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(594usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_atlas", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_atlas(&self,) -> Option < Gd < crate::engine::Texture2D > > {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_atlas", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn set_filter_clip(&mut self, enable: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_filter_clip", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn has_filter_clip(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "has_filter_clip", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for AtlasTexture {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"AtlasTexture\0")
        }
    ...
    impl crate::obj::ExportableObject for AtlasTexture {
