...
pub(super) mod re_export {
    ...
    pub trait IOccluderInstance3D: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl OccluderInstance3D {
        ...
        pub fn set_bake_simplification_distance(&mut self, simplification_distance: f32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_bake_simplification_distance", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_bake_simplification_distance(&self,) -> f32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_bake_simplification_distance", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_occluder(&mut self, occluder: Gd < crate::engine::Occluder3D >,) {
            type RetMarshal = PtrcallReturnUnit;
            type CallSig = ((), Gd < crate::engine::Occluder3D >);
            let args = (occluder,);
            unsafe {
        ...
        pub fn get_occluder(&self,) -> Option < Gd < crate::engine::Occluder3D > > {
            type RetMarshal = PtrcallReturnOptionGdT < Gd < crate::engine::Occluder3D > >;
            type CallSig = (Option < Gd < crate::engine::Occluder3D > >,);
            let args = ();
            unsafe {
    ...
    impl crate::obj::GodotClass for OccluderInstance3D {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"OccluderInstance3D\0")
        }
    ...
    impl crate::obj::ExportableObject for OccluderInstance3D {
