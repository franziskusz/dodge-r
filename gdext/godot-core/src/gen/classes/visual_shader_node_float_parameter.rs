...
pub(super) mod re_export {
    ...
    pub trait IVisualShaderNodeFloatParameter: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl VisualShaderNodeFloatParameter {
        ...
        pub fn set_hint(&mut self, hint: crate::engine::visual_shader_node_float_parameter::Hint,) {
            type RetMarshal = PtrcallReturnUnit;
            type CallSig = ((), crate::engine::visual_shader_node_float_parameter::Hint);
            let args = (hint,);
            unsafe {
        ...
        pub fn get_hint(&self,) -> crate::engine::visual_shader_node_float_parameter::Hint {
            type RetMarshal = PtrcallReturnT < crate::engine::visual_shader_node_float_parameter::Hint >;
            type CallSig = (crate::engine::visual_shader_node_float_parameter::Hint,);
            let args = ();
            unsafe {
    ...
    impl crate::obj::GodotClass for VisualShaderNodeFloatParameter {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"VisualShaderNodeFloatParameter\0")
        }
    ...
    impl crate::obj::Inherits < crate::engine::VisualShaderNodeParameter > for VisualShaderNodeFloatParameter {
    ...
    impl crate::obj::ExportableObject for VisualShaderNodeFloatParameter {
    ...
    macro_rules !inherits_transitive_VisualShaderNodeFloatParameter {
        ($Class: ident) => {
            impl::godot::obj::Inherits < ::godot::engine::VisualShaderNodeFloatParameter > for $Class {
