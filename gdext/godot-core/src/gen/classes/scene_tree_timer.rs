...
pub(super) mod re_export {
    ...
    pub trait ISceneTreeTimer: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl SceneTreeTimer {
        pub fn set_time_left(&mut self, time: f64,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_time_left", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for SceneTreeTimer {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"SceneTreeTimer\0")
        }
