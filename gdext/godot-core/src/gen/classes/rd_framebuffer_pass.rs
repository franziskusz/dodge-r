...
pub(super) mod re_export {
    ...
    pub trait IRdFramebufferPass: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl RdFramebufferPass {
        ...
        pub fn set_color_attachments(&mut self, p_member: PackedInt32Array,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_color_attachments", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_color_attachments(&self,) -> PackedInt32Array {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_color_attachments", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_input_attachments(&mut self, p_member: PackedInt32Array,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_input_attachments", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_input_attachments(&self,) -> PackedInt32Array {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_input_attachments", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_resolve_attachments(&mut self, p_member: PackedInt32Array,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_resolve_attachments", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_resolve_attachments(&self,) -> PackedInt32Array {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_resolve_attachments", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_preserve_attachments(&mut self, p_member: PackedInt32Array,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_preserve_attachments", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_preserve_attachments(&self,) -> PackedInt32Array {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_preserve_attachments", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_depth_attachment(&mut self, p_member: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_depth_attachment", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_depth_attachment(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_depth_attachment", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for RdFramebufferPass {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"RDFramebufferPass\0")
        }
