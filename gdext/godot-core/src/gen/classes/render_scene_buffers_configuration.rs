...
pub(super) mod re_export {
    ...
    impl RenderSceneBuffersConfiguration {
        ...
        pub fn set_render_target(&mut self, render_target: Rid,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_render_target", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn set_internal_size(&mut self, internal_size: Vector2i,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_internal_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_target_size(&self,) -> Vector2i {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_target_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_target_size(&mut self, target_size: Vector2i,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_target_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn set_view_count(&mut self, view_count: u32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_view_count", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_scaling_3d_mode(&self,) -> crate::engine::rendering_server::ViewportScaling3DMode {
            type RetMarshal = PtrcallReturnT < crate::engine::rendering_server::ViewportScaling3DMode >;
            type CallSig = (crate::engine::rendering_server::ViewportScaling3DMode,);
            let args = ();
            unsafe {
        ...
        pub fn set_scaling_3d_mode(&mut self, scaling_3d_mode: crate::engine::rendering_server::ViewportScaling3DMode,) {
            type RetMarshal = PtrcallReturnUnit;
            type CallSig = ((), crate::engine::rendering_server::ViewportScaling3DMode);
        ...
        pub fn get_msaa_3d(&self,) -> crate::engine::rendering_server::ViewportMSAA {
            type RetMarshal = PtrcallReturnT < crate::engine::rendering_server::ViewportMSAA >;
            type CallSig = (crate::engine::rendering_server::ViewportMSAA,);
            let args = ();
            unsafe {
        ...
        pub fn set_msaa_3d(&mut self, msaa_3d: crate::engine::rendering_server::ViewportMSAA,) {
            type RetMarshal = PtrcallReturnUnit;
            type CallSig = ((), crate::engine::rendering_server::ViewportMSAA);
            let args = (msaa_3d,);
            unsafe {
        ...
        pub fn get_screen_space_aa(&self,) -> crate::engine::rendering_server::ViewportScreenSpaceAA {
            type RetMarshal = PtrcallReturnT < crate::engine::rendering_server::ViewportScreenSpaceAA >;
            type CallSig = (crate::engine::rendering_server::ViewportScreenSpaceAA,);
            let args = ();
            unsafe {
        ...
        pub fn set_screen_space_aa(&mut self, screen_space_aa: crate::engine::rendering_server::ViewportScreenSpaceAA,) {
            type RetMarshal = PtrcallReturnUnit;
            type CallSig = ((), crate::engine::rendering_server::ViewportScreenSpaceAA);
    ...
    impl crate::obj::GodotClass for RenderSceneBuffersConfiguration {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"RenderSceneBuffersConfiguration\0")
        }
    ...
    impl crate::obj::EngineClass for RenderSceneBuffersConfiguration {
    ...
    impl crate::obj::Inherits < crate::engine::RefCounted > for RenderSceneBuffersConfiguration {
        
    }
    impl crate::obj::Inherits < crate::engine::Object > for RenderSceneBuffersConfiguration {
    ...
    macro_rules !inherits_transitive_RenderSceneBuffersConfiguration {
        ($Class: ident) => {
            impl::godot::obj::Inherits < ::godot::engine::RenderSceneBuffersConfiguration > for $Class {
