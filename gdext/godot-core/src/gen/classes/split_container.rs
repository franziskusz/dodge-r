...
pub(super) mod re_export {
    ...
    pub trait ISplitContainer: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl SplitContainer {
        pub fn set_split_offset(&mut self, offset: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_split_offset", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_split_offset(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_split_offset", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn clamp_split_offset(&mut self,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "clamp_split_offset", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn set_dragger_visibility(&mut self, mode: crate::engine::split_container::DraggerVisibility,) {
            type RetMarshal = PtrcallReturnUnit;
            type CallSig = ((), crate::engine::split_container::DraggerVisibility);
            let args = (mode,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(7719usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_dragger_visibility", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_dragger_visibility(&self,) -> crate::engine::split_container::DraggerVisibility {
            type RetMarshal = PtrcallReturnT < crate::engine::split_container::DraggerVisibility >;
            type CallSig = (crate::engine::split_container::DraggerVisibility,);
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(7720usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_dragger_visibility", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for SplitContainer {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"SplitContainer\0")
        }
    ...
    impl crate::obj::ExportableObject for SplitContainer {
...
impl DraggerVisibility {
    pub const DRAGGER_VISIBLE: Self = Self {
        ord: 0i32
    };
    pub const DRAGGER_HIDDEN: Self = Self {
        ord: 1i32
    };
    pub const DRAGGER_HIDDEN_COLLAPSED: Self = Self {
        ord: 2i32
    };
...
impl crate::builtin::meta::GodotConvert for DraggerVisibility {
    type Via = i32;
    
}
impl crate::builtin::meta::ToGodot for DraggerVisibility {
    fn to_godot(&self) -> Self::Via {
        < Self as crate::obj::EngineEnum > ::ord(* self)
    }
}
impl crate::builtin::meta::FromGodot for DraggerVisibility {
