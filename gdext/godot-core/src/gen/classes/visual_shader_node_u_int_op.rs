...
pub(super) mod re_export {
    ...
    pub trait IVisualShaderNodeUIntOp: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl VisualShaderNodeUIntOp {
        ...
        pub fn set_operator(&mut self, op: crate::engine::visual_shader_node_u_int_op::Operator,) {
            type RetMarshal = PtrcallReturnUnit;
            type CallSig = ((), crate::engine::visual_shader_node_u_int_op::Operator);
            let args = (op,);
            unsafe {
        ...
        pub fn get_operator(&self,) -> crate::engine::visual_shader_node_u_int_op::Operator {
            type RetMarshal = PtrcallReturnT < crate::engine::visual_shader_node_u_int_op::Operator >;
            type CallSig = (crate::engine::visual_shader_node_u_int_op::Operator,);
            let args = ();
            unsafe {
    ...
    impl crate::obj::GodotClass for VisualShaderNodeUIntOp {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"VisualShaderNodeUIntOp\0")
        }
    ...
    impl crate::obj::ExportableObject for VisualShaderNodeUIntOp {
...
impl Operator {
    ...
    pub const OP_BITWISE_AND: Self = Self {
        ord: 7i32
    };
    pub const OP_BITWISE_OR: Self = Self {
        ord: 8i32
    };
    pub const OP_BITWISE_XOR: Self = Self {
        ord: 9i32
    };
    pub const OP_BITWISE_LEFT_SHIFT: Self = Self {
        ord: 10i32
    };
    pub const OP_BITWISE_RIGHT_SHIFT: Self = Self {
        ord: 11i32
    };
