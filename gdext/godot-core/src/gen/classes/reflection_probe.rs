...
pub(super) mod re_export {
    ...
    pub trait IReflectionProbe: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl ReflectionProbe {
        ...
        pub fn set_ambient_mode(&mut self, ambient: crate::engine::reflection_probe::AmbientMode,) {
            type RetMarshal = PtrcallReturnUnit;
            type CallSig = ((), crate::engine::reflection_probe::AmbientMode);
            let args = (ambient,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(6776usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_ambient_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_ambient_mode(&self,) -> crate::engine::reflection_probe::AmbientMode {
            type RetMarshal = PtrcallReturnT < crate::engine::reflection_probe::AmbientMode >;
            type CallSig = (crate::engine::reflection_probe::AmbientMode,);
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(6777usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_ambient_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_ambient_color(&mut self, ambient: Color,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_ambient_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_ambient_color(&self,) -> Color {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_ambient_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_ambient_color_energy(&mut self, ambient_energy: f32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_ambient_color_energy", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_ambient_color_energy(&self,) -> f32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_ambient_color_energy", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn set_origin_offset(&mut self, origin_offset: Vector3,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_origin_offset", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_origin_offset(&self,) -> Vector3 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_origin_offset", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_as_interior(&mut self, enable: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_as_interior", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_set_as_interior(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "is_set_as_interior", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_enable_box_projection(&mut self, enable: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_enable_box_projection", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_box_projection_enabled(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "is_box_projection_enabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_enable_shadows(&mut self, enable: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_enable_shadows", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn are_shadows_enabled(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "are_shadows_enabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn set_update_mode(&mut self, mode: crate::engine::reflection_probe::UpdateMode,) {
            type RetMarshal = PtrcallReturnUnit;
            type CallSig = ((), crate::engine::reflection_probe::UpdateMode);
            let args = (mode,);
            unsafe {
        ...
        pub fn get_update_mode(&self,) -> crate::engine::reflection_probe::UpdateMode {
            type RetMarshal = PtrcallReturnT < crate::engine::reflection_probe::UpdateMode >;
            type CallSig = (crate::engine::reflection_probe::UpdateMode,);
            let args = ();
            unsafe {
    ...
    impl crate::obj::GodotClass for ReflectionProbe {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"ReflectionProbe\0")
        }
    ...
    impl crate::obj::ExportableObject for ReflectionProbe {
...
impl AmbientMode {
    pub const AMBIENT_DISABLED: Self = Self {
        ord: 0i32
    };
    pub const AMBIENT_ENVIRONMENT: Self = Self {
        ord: 1i32
    };
    pub const AMBIENT_COLOR: Self = Self {
        ord: 2i32
    };
...
impl crate::builtin::meta::GodotConvert for AmbientMode {
    type Via = i32;
    
}
impl crate::builtin::meta::ToGodot for AmbientMode {
    fn to_godot(&self) -> Self::Via {
        < Self as crate::obj::EngineEnum > ::ord(* self)
    }
}
impl crate::builtin::meta::FromGodot for AmbientMode {
    fn try_from_godot(via: Self::Via) -> std::result::Result < Self, crate::builtin::meta::ConvertError > {
        < Self as crate::obj::EngineEnum > ::try_from_ord(via) . ok_or_else(|| crate::builtin::meta::FromGodotError::InvalidEnum.into_error(via))
    }
}