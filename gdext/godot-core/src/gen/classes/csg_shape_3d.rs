...
pub(super) mod re_export {
    ...
    pub trait ICsgShape3D: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl CsgShape3D {
        pub fn is_root_shape(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "is_root_shape", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_operation(&mut self, operation: crate::engine::csg_shape_3d::Operation,) {
            type RetMarshal = PtrcallReturnUnit;
            type CallSig = ((), crate::engine::csg_shape_3d::Operation);
            let args = (operation,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(1382usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_operation", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_operation(&self,) -> crate::engine::csg_shape_3d::Operation {
            type RetMarshal = PtrcallReturnT < crate::engine::csg_shape_3d::Operation >;
            type CallSig = (crate::engine::csg_shape_3d::Operation,);
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(1383usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_operation", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn set_use_collision(&mut self, operation: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_use_collision", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_using_collision(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "is_using_collision", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn set_calculate_tangents(&mut self, enabled: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_calculate_tangents", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_calculating_tangents(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "is_calculating_tangents", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for CsgShape3D {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"CSGShape3D\0")
        }
    ...
    impl crate::obj::ExportableObject for CsgShape3D {
...
impl Operation {
    ...
    pub const OPERATION_SUBTRACTION: Self = Self {
        ord: 2i32
    };
...
impl crate::builtin::meta::GodotConvert for Operation {
    type Via = i32;
    
}
impl crate::builtin::meta::ToGodot for Operation {
    fn to_godot(&self) -> Self::Via {
        < Self as crate::obj::EngineEnum > ::ord(* self)
    }
}
impl crate::builtin::meta::FromGodot for Operation {
