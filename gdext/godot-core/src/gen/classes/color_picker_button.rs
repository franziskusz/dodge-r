...
pub(super) mod re_export {
    ...
    pub trait IColorPickerButton: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl ColorPickerButton {
        ...
        pub fn get_picker(&mut self,) -> Option < Gd < crate::engine::ColorPicker > > {
            type RetMarshal = PtrcallReturnOptionGdT < Gd < crate::engine::ColorPicker > >;
            type CallSig = (Option < Gd < crate::engine::ColorPicker > >,);
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(2149usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_picker", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_popup(&mut self,) -> Option < Gd < crate::engine::PopupPanel > > {
            type RetMarshal = PtrcallReturnOptionGdT < Gd < crate::engine::PopupPanel > >;
            type CallSig = (Option < Gd < crate::engine::PopupPanel > >,);
            let args = ();
            unsafe {
    ...
    impl crate::obj::GodotClass for ColorPickerButton {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"ColorPickerButton\0")
        }
    ...
    impl crate::obj::ExportableObject for ColorPickerButton {
