...
pub(super) mod re_export {
    ...
    pub trait IMultiplayerPeerExtension: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
        ...
        fn put_packet_script(&mut self, p_buffer: PackedByteArray,) -> crate::engine::global::Error {
            unimplemented !()
        }
        fn get_packet_channel(&self,) -> i32 {
            unimplemented !()
        }
        fn get_packet_mode(&self,) -> crate::engine::multiplayer_peer::TransferMode {
            unimplemented !()
        }
        ...
        fn set_transfer_mode(&mut self, p_mode: crate::engine::multiplayer_peer::TransferMode,) {
            unimplemented !()
        }
        fn get_transfer_mode(&self,) -> crate::engine::multiplayer_peer::TransferMode {
            unimplemented !()
        }
        ...
        fn get_connection_status(&self,) -> crate::engine::multiplayer_peer::ConnectionStatus {
            unimplemented !()
        }
    }
    ...
    impl crate::obj::GodotClass for MultiplayerPeerExtension {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"MultiplayerPeerExtension\0")
        }
