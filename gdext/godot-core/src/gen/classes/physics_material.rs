...
pub(super) mod re_export {
    ...
    pub trait IPhysicsMaterial: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl PhysicsMaterial {
        ...
        pub fn set_rough(&mut self, rough: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_rough", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_rough(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "is_rough", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn set_absorbent(&mut self, absorbent: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_absorbent", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_absorbent(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "is_absorbent", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for PhysicsMaterial {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"PhysicsMaterial\0")
        }
    ...
    impl crate::obj::ExportableObject for PhysicsMaterial {
