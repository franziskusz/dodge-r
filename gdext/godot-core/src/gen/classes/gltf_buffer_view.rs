...
pub(super) mod re_export {
    ...
    pub trait IGltfBufferView: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl GltfBufferView {
        ...
        pub fn get_buffer(&mut self,) -> i32 {
        ...
        pub fn get_byte_length(&mut self,) -> i32 {
            type RetMarshal = PtrcallReturnT < i32 >;
            type CallSig = (i32,);
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(3130usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_byte_length", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_byte_length(&mut self, byte_length: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_byte_length", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_byte_stride(&mut self,) -> i32 {
            type RetMarshal = PtrcallReturnT < i32 >;
            type CallSig = (i32,);
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(3132usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_byte_stride", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_byte_stride(&mut self, byte_stride: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_byte_stride", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for GltfBufferView {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"GLTFBufferView\0")
        }
    ...
    impl crate::obj::ExportableObject for GltfBufferView {
