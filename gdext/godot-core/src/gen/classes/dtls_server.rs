...
pub(super) mod re_export {
    ...
    pub trait IDtlsServer: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl DtlsServer {
        ...
        pub fn setup(&mut self, server_options: Gd < crate::engine::TlsOptions >,) -> crate::engine::global::Error {
        ...
        pub fn take_connection(&mut self, udp_peer: Gd < crate::engine::PacketPeerUdp >,) -> Option < Gd < crate::engine::PacketPeerDtls > > {
            type RetMarshal = PtrcallReturnOptionGdT < Gd < crate::engine::PacketPeerDtls > >;
            type CallSig = (Option < Gd < crate::engine::PacketPeerDtls > >, Gd < crate::engine::PacketPeerUdp >);
            let args = (udp_peer,);
            unsafe {
    ...
    impl crate::obj::GodotClass for DtlsServer {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"DTLSServer\0")
        }
