use crate::{
    GDExtensionVariantOperator, GDExtensionVariantType
};
...
impl VariantType {
    ...
    pub fn from_sys(enumerator: GDExtensionVariantType) -> Self {
        match enumerator {
            0 => Self::Nil, 1 => Self::Bool, 2 => Self::Int, 3 => Self::Float, 4 => Self::String, 5 => Self::Vector2, 6 => Self::Vector2i, 7 => Self::Rect2, 8 => Self::Rect2i, 9 => Self::Vector3, 10 => Self::Vector3i, 11 => Self::Transform2D, 12 => Self::Vector4, 13 => Self::Vector4i, 14 => Self::Plane, 15 => Self::Quaternion, 16 => Self::Aabb, 17 => Self::Basis, 18 => Self::Transform3D, 19 => Self::Projection, 20 => Self::Color, 21 => Self::StringName, 22 => Self::NodePath, 23 => Self::Rid, 24 => Self::Object, 25 => Self::Callable, 26 => Self::Signal, 27 => Self::Dictionary, 28 => Self::Array, 29 => Self::PackedByteArray, 30 => Self::PackedInt32Array, 31 => Self::PackedInt64Array, 32 => Self::PackedFloat32Array, 33 => Self::PackedFloat64Array, 34 => Self::PackedStringArray, 35 => Self::PackedVector2Array, 36 => Self::PackedVector3Array, 37 => Self::PackedColorArray, _ => unreachable !("invalid variant type {}", enumerator)
        }
    }
    #[doc(hidden)]
...
pub enum VariantOperator {
    Equal = 0, NotEqual = 1, Less = 2, LessEqual = 3, Greater = 4, GreaterEqual = 5, Add = 6, Subtract = 7, Multiply = 8, Divide = 9, Negate = 10, Positive = 11, Modulo = 12, Power = 13, ShiftLeft = 14, ShiftRight = 15, BitAnd = 16, BitOr = 17, BitXor = 18, BitNegate = 19, And = 20, Or = 21, Xor = 22, Not = 23, In = 24,
}
impl VariantOperator {
    #[doc(hidden)]
    pub fn from_sys(enumerator: GDExtensionVariantOperator) -> Self {
        match enumerator {
            0 => Self::Equal, 1 => Self::NotEqual, 2 => Self::Less, 3 => Self::LessEqual, 4 => Self::Greater, 5 => Self::GreaterEqual, 6 => Self::Add, 7 => Self::Subtract, 8 => Self::Multiply, 9 => Self::Divide, 10 => Self::Negate, 11 => Self::Positive, 12 => Self::Modulo, 13 => Self::Power, 14 => Self::ShiftLeft, 15 => Self::ShiftRight, 16 => Self::BitAnd, 17 => Self::BitOr, 18 => Self::BitXor, 19 => Self::BitNegate, 20 => Self::And, 21 => Self::Or, 22 => Self::Xor, 23 => Self::Not, 24 => Self::In, _ => unreachable !("invalid variant operator {}", enumerator)
        }
    }
    #[doc(hidden)]
