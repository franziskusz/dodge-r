...
pub(super) mod re_export {
    ...
    pub trait IRayCast3D: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl RayCast3D {
        ...
        pub fn get_collision_face_index(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_collision_face_index", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn set_debug_shape_thickness(&mut self, debug_shape_thickness: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_debug_shape_thickness", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_debug_shape_thickness(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_debug_shape_thickness", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for RayCast3D {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"RayCast3D\0")
        }
    ...
    impl crate::obj::ExportableObject for RayCast3D {
