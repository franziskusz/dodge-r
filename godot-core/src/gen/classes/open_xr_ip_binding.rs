...
pub(super) mod re_export {
    ...
    pub trait IOpenXrIpBinding: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl OpenXrIpBinding {
        ...
        pub fn set_action(&mut self, action: Gd < crate::engine::OpenXrAction >,) {
            type RetMarshal = PtrcallReturnUnit;
            type CallSig = ((), Gd < crate::engine::OpenXrAction >);
            let args = (action,);
            unsafe {
        ...
        pub fn get_action(&self,) -> Option < Gd < crate::engine::OpenXrAction > > {
            type RetMarshal = PtrcallReturnOptionGdT < Gd < crate::engine::OpenXrAction > >;
            type CallSig = (Option < Gd < crate::engine::OpenXrAction > >,);
            let args = ();
            unsafe {
        ...
        pub fn get_path_count(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_path_count", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_paths(&mut self, paths: PackedStringArray,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_paths", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_paths(&self,) -> PackedStringArray {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_paths", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn has_path(&self, path: GString,) -> bool {
            type RetMarshal = PtrcallReturnT < bool >;
            type CallSig = (bool, GString);
            let args = (path,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(5330usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "has_path", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn add_path(&mut self, path: GString,) {
            type RetMarshal = PtrcallReturnUnit;
            type CallSig = ((), GString);
            let args = (path,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(5331usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "add_path", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn remove_path(&mut self, path: GString,) {
            type RetMarshal = PtrcallReturnUnit;
            type CallSig = ((), GString);
            let args = (path,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(5332usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "remove_path", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for OpenXrIpBinding {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"OpenXRIPBinding\0")
        }
    ...
    impl crate::obj::ExportableObject for OpenXrIpBinding {
