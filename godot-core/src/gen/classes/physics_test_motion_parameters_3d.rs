...
pub(super) mod re_export {
    ...
    pub trait IPhysicsTestMotionParameters3D: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl PhysicsTestMotionParameters3D {
        ...
        pub fn get_max_collisions(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_max_collisions", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_max_collisions(&mut self, max_collisions: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_max_collisions", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for PhysicsTestMotionParameters3D {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"PhysicsTestMotionParameters3D\0")
        }
