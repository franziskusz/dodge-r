...
pub(super) mod re_export {
    ...
    pub trait IConcavePolygonShape3D: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl ConcavePolygonShape3D {
        ...
        pub fn set_faces(&mut self, faces: PackedVector3Array,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_faces", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn set_backface_collision_enabled(&mut self, enabled: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_backface_collision_enabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_backface_collision_enabled(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "is_backface_collision_enabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for ConcavePolygonShape3D {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"ConcavePolygonShape3D\0")
        }
    ...
    impl crate::obj::ExportableObject for ConcavePolygonShape3D {
