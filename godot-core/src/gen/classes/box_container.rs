...
pub(super) mod re_export {
    ...
    pub trait IBoxContainer: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl BoxContainer {
        pub fn add_spacer(&mut self, begin: bool,) -> Option < Gd < crate::engine::Control > > {
            type RetMarshal = PtrcallReturnOptionGdT < Gd < crate::engine::Control > >;
            type CallSig = (Option < Gd < crate::engine::Control > >, bool);
            let args = (begin,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(1136usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "add_spacer", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_alignment(&mut self, alignment: crate::engine::box_container::AlignmentMode,) {
            type RetMarshal = PtrcallReturnUnit;
            type CallSig = ((), crate::engine::box_container::AlignmentMode);
            let args = (alignment,);
            unsafe {
        ...
        pub fn get_alignment(&self,) -> crate::engine::box_container::AlignmentMode {
            type RetMarshal = PtrcallReturnT < crate::engine::box_container::AlignmentMode >;
            type CallSig = (crate::engine::box_container::AlignmentMode,);
            let args = ();
            unsafe {
    ...
    impl crate::obj::GodotClass for BoxContainer {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"BoxContainer\0")
        }
    ...
    impl crate::obj::ExportableObject for BoxContainer {
