...
pub(super) mod re_export {
    ...
    pub trait IPolygonPathFinder: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl PolygonPathFinder {
        ...
        pub fn setup(&mut self, points: PackedVector2Array, connections: PackedInt32Array,) {
            ...
            type CallSig = ((), PackedVector2Array, PackedInt32Array);
            let args = (points, connections,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(6280usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "setup", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn find_path(&mut self, from: Vector2, to: Vector2,) -> PackedVector2Array {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "find_path", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_intersections(&self, from: Vector2, to: Vector2,) -> PackedVector2Array {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_intersections", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn is_point_inside(&self, point: Vector2,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "is_point_inside", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_point_penalty(&mut self, idx: i32, penalty: f32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_point_penalty", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_point_penalty(&self, idx: i32,) -> f32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_point_penalty", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for PolygonPathFinder {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"PolygonPathFinder\0")
        }
    ...
    impl crate::obj::ExportableObject for PolygonPathFinder {
