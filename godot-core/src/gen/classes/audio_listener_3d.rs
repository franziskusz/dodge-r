...
pub(super) mod re_export {
    ...
    pub trait IAudioListener3D: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl AudioListener3D {
        ...
        pub fn get_listener_transform(&self,) -> Transform3D {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_listener_transform", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for AudioListener3D {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"AudioListener3D\0")
        }
    ...
    impl crate::obj::ExportableObject for AudioListener3D {
