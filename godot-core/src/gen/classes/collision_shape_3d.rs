...
pub(super) mod re_export {
    ...
    pub trait ICollisionShape3D: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl CollisionShape3D {
        ...
        pub fn make_convex_from_siblings(&mut self,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "make_convex_from_siblings", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for CollisionShape3D {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"CollisionShape3D\0")
        }
    ...
    impl crate::obj::ExportableObject for CollisionShape3D {
