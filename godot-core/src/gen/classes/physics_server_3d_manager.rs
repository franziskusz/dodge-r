...
pub(super) mod re_export {
    ...
    pub trait IPhysicsServer3DManager: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl PhysicsServer3DManager {
        pub fn singleton() -> Gd < Self > {
            unsafe {
                let __class_name = StringName::from_latin1_with_nul(b"PhysicsServer3DManager\0");
    ...
    impl crate::obj::GodotClass for PhysicsServer3DManager {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"PhysicsServer3DManager\0")
        }
