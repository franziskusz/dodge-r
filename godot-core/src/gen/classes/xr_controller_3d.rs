...
pub(super) mod re_export {
    ...
    pub trait IXrController3D: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl XrController3D {
        pub fn is_button_pressed(&self, name: StringName,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "is_button_pressed", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn get_float(&self, name: StringName,) -> f32 {
        ...
        pub fn get_vector2(&self, name: StringName,) -> Vector2 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_vector2", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for XrController3D {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"XRController3D\0")
        }
    ...
    impl crate::obj::ExportableObject for XrController3D {
