...
pub(super) mod re_export {
    ...
    pub trait IVisualShaderNodeColorOp: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl VisualShaderNodeColorOp {
        ...
        pub fn set_operator(&mut self, op: crate::engine::visual_shader_node_color_op::Operator,) {
            type RetMarshal = PtrcallReturnUnit;
            type CallSig = ((), crate::engine::visual_shader_node_color_op::Operator);
            let args = (op,);
            unsafe {
        ...
        pub fn get_operator(&self,) -> crate::engine::visual_shader_node_color_op::Operator {
            type RetMarshal = PtrcallReturnT < crate::engine::visual_shader_node_color_op::Operator >;
            type CallSig = (crate::engine::visual_shader_node_color_op::Operator,);
            let args = ();
            unsafe {
    ...
    impl crate::obj::GodotClass for VisualShaderNodeColorOp {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"VisualShaderNodeColorOp\0")
        }
    ...
    impl crate::obj::ExportableObject for VisualShaderNodeColorOp {
...
impl Operator {
    pub const OP_SCREEN: Self = Self {
        ord: 0i32
    };
    pub const OP_DIFFERENCE: Self = Self {
        ord: 1i32
    };
    pub const OP_DARKEN: Self = Self {
        ord: 2i32
    };
    pub const OP_LIGHTEN: Self = Self {
        ord: 3i32
    };
    pub const OP_OVERLAY: Self = Self {
        ord: 4i32
    };
    pub const OP_DODGE: Self = Self {
        ord: 5i32
    };
    pub const OP_BURN: Self = Self {
        ord: 6i32
    };
    pub const OP_SOFT_LIGHT: Self = Self {
        ord: 7i32
    };
    pub const OP_HARD_LIGHT: Self = Self {
        ord: 8i32
    };
