...
pub(super) mod re_export {
    ...
    pub trait ITextServerDummy: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl crate::obj::GodotClass for TextServerDummy {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"TextServerDummy\0")
        }
