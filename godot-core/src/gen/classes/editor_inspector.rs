...
pub(super) mod re_export {
    ...
    pub trait IEditorInspector: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl EditorInspector {
        pub fn get_selected_path(&self,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_selected_path", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for EditorInspector {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"EditorInspector\0")
        }
    ...
    impl crate::obj::ExportableObject for EditorInspector {
