...
pub(super) mod re_export {
    ...
    pub trait IImageTexture: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl ImageTexture {
        ...
        pub fn create_from_image(image: Gd < crate::engine::Image >,) -> Option < Gd < crate::engine::ImageTexture > > {
            type RetMarshal = PtrcallReturnOptionGdT < Gd < crate::engine::ImageTexture > >;
            type CallSig = (Option < Gd < crate::engine::ImageTexture > >, Gd < crate::engine::Image >);
            let args = (image,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(3832usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "create_from_image", std::ptr::null_mut(), None, args,)
            }
        }
        ...
        pub fn set_image(&mut self, image: Gd < crate::engine::Image >,) {
            type RetMarshal = PtrcallReturnUnit;
            type CallSig = ((), Gd < crate::engine::Image >);
            let args = (image,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(3834usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_image", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn update(&mut self, image: Gd < crate::engine::Image >,) {
            type RetMarshal = PtrcallReturnUnit;
            type CallSig = ((), Gd < crate::engine::Image >);
            let args = (image,);
            unsafe {
    ...
    impl crate::obj::GodotClass for ImageTexture {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"ImageTexture\0")
        }
    ...
    impl crate::obj::ExportableObject for ImageTexture {
