...
pub(super) mod re_export {
    ...
    pub trait IAudioEffectCapture: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl AudioEffectCapture {
        ...
        pub fn can_get_buffer(&self, frames: i32,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "can_get_buffer", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn get_discarded_frames(&self,) -> i64 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_discarded_frames", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_buffer_length_frames(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_buffer_length_frames", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_pushed_frames(&self,) -> i64 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_pushed_frames", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for AudioEffectCapture {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"AudioEffectCapture\0")
        }
    ...
    impl crate::obj::ExportableObject for AudioEffectCapture {
