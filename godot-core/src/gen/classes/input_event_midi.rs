...
pub(super) mod re_export {
    ...
    pub trait IInputEventMidi: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl InputEventMidi {
        ...
        pub fn set_channel(&mut self, channel: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_channel", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_channel(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_channel", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_message(&mut self, message: crate::engine::global::MIDIMessage,) {
            type RetMarshal = PtrcallReturnUnit;
            type CallSig = ((), crate::engine::global::MIDIMessage);
            let args = (message,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(3994usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_message", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_message(&self,) -> crate::engine::global::MIDIMessage {
            type RetMarshal = PtrcallReturnT < crate::engine::global::MIDIMessage >;
            type CallSig = (crate::engine::global::MIDIMessage,);
            let args = ();
            unsafe {
        ...
        pub fn set_pitch(&mut self, pitch: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_pitch", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_pitch(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_pitch", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn set_instrument(&mut self, instrument: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_instrument", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_instrument(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_instrument", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn set_controller_number(&mut self, controller_number: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_controller_number", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_controller_number(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_controller_number", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_controller_value(&mut self, controller_value: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_controller_value", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_controller_value(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_controller_value", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for InputEventMidi {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"InputEventMIDI\0")
        }
    ...
    impl crate::obj::ExportableObject for InputEventMidi {
