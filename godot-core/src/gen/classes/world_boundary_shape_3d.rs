...
pub(super) mod re_export {
    ...
    pub trait IWorldBoundaryShape3D: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl WorldBoundaryShape3D {
        ...
        pub fn set_plane(&mut self, plane: Plane,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_plane", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_plane(&self,) -> Plane {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_plane", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for WorldBoundaryShape3D {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"WorldBoundaryShape3D\0")
        }
    ...
    impl crate::obj::ExportableObject for WorldBoundaryShape3D {
