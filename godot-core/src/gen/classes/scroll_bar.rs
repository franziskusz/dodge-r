...
pub(super) mod re_export {
    ...
    pub trait IScrollBar: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl ScrollBar {
        pub fn set_custom_step(&mut self, step: f32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_custom_step", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_custom_step(&self,) -> f32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_custom_step", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for ScrollBar {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"ScrollBar\0")
        }
    ...
    impl crate::obj::ExportableObject for ScrollBar {
