...
pub(super) mod re_export {
    ...
    pub trait IShape3D: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl Shape3D {
        ...
        pub fn get_debug_mesh(&mut self,) -> Option < Gd < crate::engine::ArrayMesh > > {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_debug_mesh", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for Shape3D {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"Shape3D\0")
        }
    ...
    impl crate::obj::ExportableObject for Shape3D {
