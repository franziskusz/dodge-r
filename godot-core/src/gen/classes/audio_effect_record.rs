...
pub(super) mod re_export {
    ...
    pub trait IAudioEffectRecord: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl AudioEffectRecord {
        ...
        pub fn set_recording_active(&mut self, record: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_recording_active", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_recording_active(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "is_recording_active", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn get_recording(&self,) -> Option < Gd < crate::engine::AudioStreamWav > > {
            type RetMarshal = PtrcallReturnOptionGdT < Gd < crate::engine::AudioStreamWav > >;
            type CallSig = (Option < Gd < crate::engine::AudioStreamWav > >,);
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(722usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_recording", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for AudioEffectRecord {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"AudioEffectRecord\0")
        }
    ...
    impl crate::obj::ExportableObject for AudioEffectRecord {
