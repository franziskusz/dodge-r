...
pub(super) mod re_export {
    ...
    pub trait ISyntaxHighlighter: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl SyntaxHighlighter {
        ...
        pub fn get_line_syntax_highlighting(&mut self, line: i32,) -> Dictionary {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_line_syntax_highlighting", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn update_cache(&mut self,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "update_cache", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn clear_highlighting_cache(&mut self,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "clear_highlighting_cache", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_text_edit(&self,) -> Option < Gd < crate::engine::TextEdit > > {
            type RetMarshal = PtrcallReturnOptionGdT < Gd < crate::engine::TextEdit > >;
            type CallSig = (Option < Gd < crate::engine::TextEdit > >,);
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(8012usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_text_edit", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for SyntaxHighlighter {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"SyntaxHighlighter\0")
        }
    ...
    impl crate::obj::ExportableObject for SyntaxHighlighter {
