...
pub(super) mod re_export {
    ...
    pub trait IAnimatedTexture: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl AnimatedTexture {
        ...
        pub fn set_frames(&mut self, frames: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_frames", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_frames(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_frames", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_current_frame(&mut self, frame: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_current_frame", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_current_frame(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_current_frame", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn get_pause(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "get_pause", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn set_frame_texture(&mut self, frame: i32, texture: Gd < crate::engine::Texture2D >,) {
            type RetMarshal = PtrcallReturnUnit;
            type CallSig = ((), i32, Gd < crate::engine::Texture2D >);
            let args = (frame, texture,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(156usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_frame_texture", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_frame_texture(&self, frame: i32,) -> Option < Gd < crate::engine::Texture2D > > {
        ...
        pub fn set_frame_duration(&mut self, frame: i32, duration: f32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall::< RetMarshal > (method_bind, "set_frame_duration", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for AnimatedTexture {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"AnimatedTexture\0")
        }
    ...
    impl crate::obj::ExportableObject for AnimatedTexture {
