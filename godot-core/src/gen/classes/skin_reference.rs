...
pub(super) mod re_export {
    ...
    pub trait ISkinReference: crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl crate::obj::GodotClass for SkinReference {
        ...
        fn class_name() -> ClassName {
            ClassName::from_ascii_cstr(b"SkinReference\0")
        }
